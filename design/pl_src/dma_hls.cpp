...
// ============================================================================
// Define the number of PLIO streams for each matrix type
// These constants determine the parallelization level for data distribution
#define NUM_A_FILES 8     // Matrix A: 8 streams for broadcast to all splits
#define NUM_B_FILES 16    // Matrix B: 16 streams (2 splits × 8 cascade levels)
#define NUM_C_FILES 2     // Matrix C: 2 streams (1 per split)

// ============================================================================
// MATRIX SIZE CALCULATIONS
// ============================================================================
// Calculate exact matrix sizes for DMA transfers
// These are now defined in the generated gemm_config.h header file
// with the correct calculations matching plioGen.py logic

// Exact matrix sizes for DMA transfers (total elements across all streams)
#define EXACT_MATA_SZ (NUM_A_FILES * BASE_MATA_SZ)    // Total Matrix A elements
#define EXACT_MATB_SZ (NUM_B_FILES * BASE_MATB_SZ)    // Total Matrix B elements  
#define EXACT_MATC_SZ (NUM_C_FILES * BASE_MATC_SZ)    // Total Matrix C elements
