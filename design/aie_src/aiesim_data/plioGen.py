...
def main():
    ...
    # Prefer sub-tile overrides from config; else compute from DATA_TYPE
    ...
    valid_dims = list_valid_tp_dims(GEMM_SIZE, DIM, SPLIT, CASC_LN, DATA_TYPE)
    if valid_dims:
    ...
    generate_split_output_files(matrix_C, SPLIT, DIM, WRD_LN, path, DATA_TYPE)
    
    # Generate cascade input files
    generate_cascade_input_files(matrix_A, matrix_B, SPLIT, CASC_LN, DIM, WRD_LN, path, DATA_TYPE)
