...
**Generated:** 
**Generated:** 2026-04-24 12:52:46
**Project:** GEMM 64×64×64 (int16, DIM=32, 16 cores)  
**Build Target:** hw
...
|----------|------|-----------|-------------|--------|
| **LUTs** | 9180 | 150,272 | **6.07%** | ✅ Very Low |
...
| Metric | Value | Status |
|--------|-------|--------|
| **WNS (Worst Negative Slack)** | 0.009 ns | ✅ PASS |
...
- **Matrix Dimensions:** A=64, AB=64, B=64
- **Tile Dimensions:** DIM_A=32, DIM_AB=8 (= GEMM_SIZE_AB / CASC_LN_AB), DIM_B=32 (config DIM=32)
- **Data Type:** int16
- **Build Target:** hw
