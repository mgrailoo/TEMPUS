...
**Generated:** 
**Generated:** 2026-04-21 13:15:41
**Project:** GEMM 512×512×512 (int16, DIM=128, 16 cores)  
**Build Target:** hw
...
|----------|------|-----------|-------------|--------|
| **LUTs** | 9282 | 150,272 | **6.07%** | ✅ Very Low |
...
| Metric | Value | Status |
|--------|-------|--------|
| **WNS (Worst Negative Slack)** | 0.010 ns | ✅ PASS |
...
- **Matrix Dimensions:** A=512, AB=512, B=512
- **Tile Dimensions:** DIM_A=128, DIM_AB=64 (= GEMM_SIZE_AB / CASC_LN_AB), DIM_B=128 (config DIM=128)
- **Data Type:** int16
- **Build Target:** hw
