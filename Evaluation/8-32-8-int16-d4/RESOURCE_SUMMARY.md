...
**Generated:** 
**Generated:** 2026-04-24 16:09:20
**Project:** GEMM 8×32×8 (int16, DIM=4, 16 cores)  
**Build Target:** hw
...
|----------|------|-----------|-------------|--------|
| **LUTs** | 9181 | 150,272 | **6.07%** | ✅ Very Low |
...
- **Matrix Dimensions:** A=8, AB=32, B=8
- **Tile Dimensions:** DIM_A=4, DIM_AB=4 (= GEMM_SIZE_AB / CASC_LN_AB), DIM_B=4 (config DIM=4)
- **Data Type:** int16
- **Build Target:** hw
