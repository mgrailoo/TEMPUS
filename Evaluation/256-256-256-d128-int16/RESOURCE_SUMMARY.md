...
**Generated:** 
**Generated:** 2026-04-23 15:41:25
**Project:** GEMM 256×256×256 (int16, DIM=128, 16 cores)  
**Build Target:** hw
...
|----------|------|-----------|-------------|--------|
| **LUTs** | 9184 | 150,272 | **6.07%** | ✅ Very Low |
...
- **Tile Dimensions:** DIM_A=128, DIM_AB=32 (= GEMM_SIZE_AB / CASC_LN_AB), DIM_B=128 (config DIM=128)
- **Data Type:** int16
- **Build Target:** hw
