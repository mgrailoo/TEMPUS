...
**Generated:** 
**Generated:** 2026-04-24 18:32:22
**Project:** GEMM 8×2048×2048 (int16, DIM=64, 16 cores)  
**Build Target:** hw
...
|----------|------|-----------|-------------|--------|
| **LUTs** | 9241 | 150,272 | **6.07%** | ✅ Very Low |
...
- **Matrix Dimensions:** A=8, AB=2048, B=2048
- **Tile Dimensions:** DIM_A=4, DIM_AB=256 (= GEMM_SIZE_AB / CASC_LN_AB), DIM_B=64 (config DIM=64)
- **Data Type:** int16
- **Build Target:** hw
