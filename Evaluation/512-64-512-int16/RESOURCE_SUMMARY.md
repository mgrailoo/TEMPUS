...
**Generated:** 
**Generated:** 2026-04-25 12:18:32
**Project:** GEMM 512×64×512 (int16, DIM=128, 16 cores)  
**Build Target:** hw
...
|----------|------|-----------|-------------|--------|
| **LUTs** | 9189 | 150,272 | **6.07%** | ✅ Very Low |
...
- **Matrix Dimensions:** A=512, AB=64, B=512
- **Tile Dimensions:** DIM_A=128, DIM_AB=8 (= GEMM_SIZE_AB / CASC_LN_AB), DIM_B=128 (config DIM=128)
- **Data Type:** int16
- **Build Target:** hw
