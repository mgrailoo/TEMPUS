...
**Generated:** 
**Generated:** 2026-04-25 11:30:53
**Project:** GEMM 768×768×768 (int16, DIM=64, 16 cores)  
**Build Target:** hw
...
|----------|------|-----------|-------------|--------|
| **LUTs** | 9312 | 150,272 | **6.07%** | ✅ Very Low |
...
- **Tile Dimensions:** DIM_A=64, DIM_AB=96 (= GEMM_SIZE_AB / CASC_LN_AB), DIM_B=64 (config DIM=64)
- **Data Type:** int16
- **Build Target:** hw
