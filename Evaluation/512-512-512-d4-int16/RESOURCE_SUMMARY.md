...
**Generated:** 
**Generated:** 2026-04-23 12:19:22
**Project:** GEMM 512×512×512 (int16, DIM=4, 16 cores)  
**Build Target:** hw
...
|----------|------|-----------|-------------|--------|
| **LUTs** | 9317 | 150,272 | **6.07%** | ✅ Very Low |
...
- **Tile Dimensions:** DIM_A=4, DIM_AB=64 (= GEMM_SIZE_AB / CASC_LN_AB), DIM_B=4 (config DIM=4)
- **Data Type:** int16
- **Build Target:** hw
