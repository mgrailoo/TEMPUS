...
**Generated:** 
**Generated:** 2026-04-24 12:08:31
**Project:** GEMM 192×192×192 (int16, DIM=96, 16 cores)  
**Build Target:** hw
...
|----------|------|-----------|-------------|--------|
| **LUTs** | 9226 | 150,272 | **6.07%** | ✅ Very Low |
...
- **Matrix Dimensions:** A=192, AB=192, B=192
- **Tile Dimensions:** DIM_A=96, DIM_AB=24 (= GEMM_SIZE_AB / CASC_LN_AB), DIM_B=96 (config DIM=96)
- **Data Type:** int16
- **Build Target:** hw
