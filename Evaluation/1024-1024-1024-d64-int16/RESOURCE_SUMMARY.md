...
**Generated:** 
**Generated:** 2026-04-21 12:03:14
**Project:** GEMM 1024×1024×1024 (int16, DIM=64, 16 cores)  
**Build Target:** hw
...
|----------|------|-----------|-------------|--------|
| **LUTs** | 9255 | 150,272 | **6.07%** | ✅ Very Low |
...
| Metric | Value | Status |
|--------|-------|--------|
| **WNS (Worst Negative Slack)** | 0.011 ns | ✅ PASS |
...
|-----------|-----------|-------|
| **Total On-Chip Power** | **10.677** | - |
| **AI Engine Power** | **2.394** | 16 cores active |
| **Memory Power** | **3.152** | BRAM + NoC-DDRMC + XRAM |
| **PL Power** | ~5.131 | Estimated |

**Power Breakdown:**
- AI Engine: 22.4% of total power
- Memory: 29.5% of total power
- PL Logic: ~48.0% of total power
...
- **Tile Dimensions:** DIM_A=64, DIM_AB=128 (= GEMM_SIZE_AB / CASC_LN_AB), DIM_B=64 (config DIM=64)
- **Data Type:** int16
- **Build Target:** hw
