...
**Generated:** 
**Generated:** 2026-04-21 18:00:45
**Project:** GEMM 512×512×512 (int32, DIM=16, 16 cores)  
**Build Target:** hw
...
|----------|------|-----------|-------------|--------|
| **LUTs** | 9240 | 150,272 | **6.07%** | ✅ Very Low |
...
- **Tile Dimensions:** DIM_A=16, DIM_AB=64 (= GEMM_SIZE_AB / CASC_LN_AB), DIM_B=16 (config DIM=16)
- **Data Type:** int32
- **Build Target:** hw
