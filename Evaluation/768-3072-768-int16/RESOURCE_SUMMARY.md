...
**Generated:** 
**Generated:** 2026-04-25 13:57:07
**Project:** GEMM 768×3072×768 (int16, DIM=16, 16 cores)  
**Build Target:** hw
...
|----------|------|-----------|-------------|--------|
| **LUTs** | 9293 | 150,272 | **6.07%** | ✅ Very Low |
...
| **inp_A (Total)** | **426.075867** | **dma_hls_1** | **311.526489** | **Matrix A processing** |
...
**Note:** The rearrangement logic (inp_A_producer + inp_A_consumer) uses 426.075867 LUT + 311.526489 BRAM, which is a significant portion of the DMA kernel's resources.
...
| Metric | Value | Status |
|--------|-------|--------|
| **WNS (Worst Negative Slack)** | 0.016 ns | ✅ PASS |
...
- Matrix A rearrangement logic: 426.075867 LUT (48% of DMA kernel)
...
- **Matrix Dimensions:** A=768, AB=3072, B=768
- **Tile Dimensions:** DIM_A=16, DIM_AB=384 (= GEMM_SIZE_AB / CASC_LN_AB), DIM_B=16 (config DIM=16)
- **Data Type:** int16
- **Build Target:** hw
