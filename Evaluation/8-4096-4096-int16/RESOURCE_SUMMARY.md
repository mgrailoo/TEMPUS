...
**Generated:** 
**Generated:** 2026-04-25 14:47:12
**Project:** GEMM 8×4096×4096 (int16, DIM=32, 16 cores)  
**Build Target:** hw
...
|----------|------|-----------|-------------|--------|
| **LUTs** | 9296 | 150,272 | **6.07%** | ✅ Very Low |
...
| Metric | Value | Status |
|--------|-------|--------|
| **WNS (Worst Negative Slack)** | 0.007 ns | ✅ PASS |
...
- **Matrix Dimensions:** A=8, AB=4096, B=4096
- **Tile Dimensions:** DIM_A=4, DIM_AB=512 (= GEMM_SIZE_AB / CASC_LN_AB), DIM_B=32 (config DIM=32)
- **Data Type:** int16
- **Build Target:** hw
