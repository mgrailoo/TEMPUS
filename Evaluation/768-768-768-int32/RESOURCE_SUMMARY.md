...
**Generated:** 
**Generated:** 2026-04-25 15:48:56
**Project:** GEMM 768×768×768 (int32, DIM=32, 16 cores)  
**Build Target:** hw
...
|----------|------|-----------|-------------|--------|
| **LUTs** | 9350 | 150,272 | **6.07%** | ✅ Very Low |
...
| Metric | Value | Status |
|--------|-------|--------|
| **WNS (Worst Negative Slack)** | 0.004 ns | ✅ PASS |
...
|-----------|-----------|-------|
| **Total On-Chip Power** | **10.635** | - |
| **AI Engine Power** | **2.394** | 16 cores active |
| **Memory Power** | **3.152** | BRAM + NoC-DDRMC + XRAM |
| **PL Power** | ~5.089 | Estimated |

**Power Breakdown:**
- AI Engine: 22.5% of total power
- Memory: 29.6% of total power
- PL Logic: ~47.8% of total power
...
- **Matrix Dimensions:** A=768, AB=768, B=768
- **Tile Dimensions:** DIM_A=32, DIM_AB=96 (= GEMM_SIZE_AB / CASC_LN_AB), DIM_B=32 (config DIM=32)
- **Data Type:** int32
- **Build Target:** hw
