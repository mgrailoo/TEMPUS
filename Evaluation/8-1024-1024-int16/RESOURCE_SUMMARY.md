...
**Generated:** 
**Generated:** 2026-04-24 17:45:11
**Project:** GEMM 8×1024×1024 (int16, DIM=128, 16 cores)  
**Build Target:** hw
...
|----------|------|-----------|-------------|--------|
| **LUTs** | 9243 | 150,272 | **6.07%** | ✅ Very Low |
...
| Metric | Value | Status |
|--------|-------|--------|
| **WNS (Worst Negative Slack)** | 0.001 ns | ✅ PASS |
...
|-----------|-----------|-------|
| **Total On-Chip Power** | **10.282** | - |
| **AI Engine Power** | **2.394** | 16 cores active |
| **Memory Power** | **3.152** | BRAM + NoC-DDRMC + XRAM |
| **PL Power** | ~4.736 | Estimated |

**Power Breakdown:**
- AI Engine: 23.2% of total power
- Memory: 30.6% of total power
- PL Logic: ~46.0% of total power
...
- **Matrix Dimensions:** A=8, AB=1024, B=1024
- **Tile Dimensions:** DIM_A=4, DIM_AB=128 (= GEMM_SIZE_AB / CASC_LN_AB), DIM_B=128 (config DIM=128)
- **Data Type:** int16
- **Build Target:** hw
