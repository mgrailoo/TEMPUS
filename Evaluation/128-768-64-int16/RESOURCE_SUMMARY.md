...
**Generated:** 
**Generated:** 2026-04-24 16:57:39
**Project:** GEMM 128×768×64 (int16, DIM=64, 16 cores)  
**Build Target:** hw
...
|----------|------|-----------|-------------|--------|
| **LUTs** | 9233 | 150,272 | **6.07%** | ✅ Very Low |
...
- **Matrix Dimensions:** A=128, AB=768, B=64
- **Tile Dimensions:** DIM_A=64, DIM_AB=96 (= GEMM_SIZE_AB / CASC_LN_AB), DIM_B=32 (config DIM=64)
- **Data Type:** int16
- **Build Target:** hw
