...
**Generated:** 
**Generated:** 2026-04-23 14:27:24
**Project:** GEMM 256×256×256 (int32, DIM=64, 16 cores)  
**Build Target:** hw
...
|----------|------|-----------|-------------|--------|
| **LUTs** | 9256 | 150,272 | **6.07%** | ✅ Very Low |
...
- **Matrix Dimensions:** A=256, AB=256, B=256
- **Tile Dimensions:** DIM_A=64, DIM_AB=32 (= GEMM_SIZE_AB / CASC_LN_AB), DIM_B=64 (config DIM=64)
- **Data Type:** int32
- **Build Target:** hw
