...
**Generated:** 
**Generated:** 2026-04-21 15:36:40
**Project:** GEMM 512×512×512 (int32, DIM=32, 16 cores)  
**Build Target:** hw
...
|----------|------|-----------|-------------|--------|
| **LUTs** | 9267 | 150,272 | **6.07%** | ✅ Very Low |
...
- **Tile Dimensions:** DIM_A=32, DIM_AB=64 (= GEMM_SIZE_AB / CASC_LN_AB), DIM_B=32 (config DIM=32)
- **Data Type:** int32
- **Build Target:** hw
