...
**Generated:** 
**Generated:** 2026-04-21 14:37:38
**Project:** GEMM 512×512×512 (int32, DIM=64, 16 cores)  
**Build Target:** hw
...
|----------|------|-----------|-------------|--------|
| **LUTs** | 9301 | 150,272 | **6.07%** | ✅ Very Low |
...
| Metric | Value | Status |
|--------|-------|--------|
| **WNS (Worst Negative Slack)** | 0.014 ns | ✅ PASS |
...
- **Tile Dimensions:** DIM_A=64, DIM_AB=64 (= GEMM_SIZE_AB / CASC_LN_AB), DIM_B=64 (config DIM=64)
- **Data Type:** int32
- **Build Target:** hw
