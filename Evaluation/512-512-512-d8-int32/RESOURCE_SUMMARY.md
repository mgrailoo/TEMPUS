...
**Generated:** 
**Generated:** 2026-04-21 18:58:55
**Project:** GEMM 512×512×512 (int32, DIM=8, 16 cores)  
**Build Target:** hw
...
|----------|------|-----------|-------------|--------|
| **LUTs** | 9258 | 150,272 | **6.07%** | ✅ Very Low |
...
- **Tile Dimensions:** DIM_A=8, DIM_AB=64 (= GEMM_SIZE_AB / CASC_LN_AB), DIM_B=8 (config DIM=8)
- **Data Type:** int32
- **Build Target:** hw
