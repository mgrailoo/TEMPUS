...
**Generated:** 
**Generated:** 2026-04-21 10:17:33
**Project:** GEMM 1024×1024×1024 (int32, DIM=32, 16 cores)  
**Build Target:** hw
...
|----------|------|-----------|-------------|--------|
| **LUTs** | 9248 | 150,272 | **6.07%** | ✅ Very Low |
...
| Metric | Value | Status |
|--------|-------|--------|
| **WNS (Worst Negative Slack)** | 0.018 ns | ✅ PASS |
...
|-----------|-----------|-------|
| **Total On-Chip Power** | **10.267** | - |
| **AI Engine Power** | **2.394** | 16 cores active |
| **Memory Power** | **3.152** | BRAM + NoC-DDRMC + XRAM |
| **PL Power** | ~4.721 | Estimated |

**Power Breakdown:**
- AI Engine: 23.3% of total power
- Memory: 30.7% of total power
- PL Logic: ~45.9% of total power
...
- **Matrix Dimensions:** A=1024, AB=1024, B=1024
- **Tile Dimensions:** DIM_A=32, DIM_AB=128 (= GEMM_SIZE_AB / CASC_LN_AB), DIM_B=32 (config DIM=32)
- **Data Type:** int32
- **Build Target:** hw
