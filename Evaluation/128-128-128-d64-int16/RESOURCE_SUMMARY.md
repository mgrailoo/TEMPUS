...
**Generated:** 
**Generated:** 2026-04-23 16:29:52
**Project:** GEMM 128×128×128 (int16, DIM=64, 16 cores)  
**Build Target:** hw
...
|----------|------|-----------|-------------|--------|
| **LUTs** | 9218 | 150,272 | **6.07%** | ✅ Very Low |
...
|-----------|-----------|-------|
| **Total On-Chip Power** | **10.315** | - |
| **AI Engine Power** | **2.394** | 16 cores active |
| **Memory Power** | **3.152** | BRAM + NoC-DDRMC + XRAM |
| **PL Power** | ~4.769 | Estimated |

**Power Breakdown:**
- AI Engine: 23.2% of total power
- Memory: 30.5% of total power
- PL Logic: ~46.2% of total power
