...
**Generated:** 
**Generated:** 2026-04-24 19:52:58
**Project:** GEMM 128×768×3072 (int16, DIM=96, 16 cores)  
**Build Target:** hw
...
|----------|------|-----------|-------------|--------|
| **LUTs** | 9278 | 150,272 | **6.07%** | ✅ Very Low |
...
- **Matrix Dimensions:** A=128, AB=768, B=3072
- **Tile Dimensions:** DIM_A=64, DIM_AB=96 (= GEMM_SIZE_AB / CASC_LN_AB), DIM_B=96 (config DIM=96)
- **Data Type:** int16
- **Build Target:** hw
